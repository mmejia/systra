...
define(['core/sandbox'], function(sandbox) {
  var CapturaSaldoSangre;
  return CapturaSaldoSangre = {
    btnAgregar: null,
    dialogo: null,
    iniciar: function() {
      var btnAgregar, btnCancelar, btnShow, that;
      that = this;
      ...
      btnShow.on('click', function() {
        return that.showCapturaSaldoSangre();
      });
      ...
      btnAgregar.on('click', function() {
        return that.actualizarSaldoSangre();
      });
      return $("#cargar-saldo-sangre").on('click', function(evento) {
        return that.mostrarSaldoSangreOnView(0);
      });
    },
    showCapturaSaldoSangre: function() {
    ...
    mostrarSaldoSangreOnView: function(id) {
      var accidente, saldoSangre, sangres;
      ...
      return this.showCapturaSaldoSangre();
    },
    actualizarSaldoSangre: function() {
      var accidente, encontro, i, saldoSangre, sangre, sangres, _i, _len;
      ...
      encontro = -1;
      for (i = _i = 0, _len = sangres.length; _i < _len; i = ++_i) {
        sangre = sangres[i];
      ...
      this.cancelar();
      return this.sandbox.emit('actualizar-tabla-saldo-sangre');
    },
    cancelar: function() {
      $("#nombre_ss").val('');
      $("#edad_ss").val('');
    ...
    llenarSeEncontraba: function() {
      var estado, opciones, sel, _i, _len, _ref;
