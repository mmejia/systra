...
define(['../core/sandbox'], function(sandbox) {
  ...
  return app = {
    ...
    y: 0,
    iniciar: function() {},
    "in": function(x, y, texto) {
      this.pdf.setFontType("bold");
      this.pdf.text(x, y, texto);
      this.pdf.setFontType("normal");
    },
    ib: function(x, y, texto) {
      this.pdf.setFontType("normal");
      this.pdf.text(x, y, texto);
      this.pdf.setFontType("normal");
    },
    obtenerDataUrl: function(img) {
      var canvas, ctx, dataURL, e;
    ...
    generar: function(accidente) {
      var cl, dataURL, image, img_rosa, lines, rosaURL, src_rosa, tam, that, x;
      that = this;
