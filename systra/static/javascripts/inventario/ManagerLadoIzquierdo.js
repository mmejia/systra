...
define(['core/sandbox'], function(sandbox) {
  var MangerLadoIzquierdo;
  return MangerLadoIzquierdo = {
    salpiDer11: null,
    salpiDer21: null,
    salpiDer31: null,
    salpiDer41: null,
    ...
    iniciar: function() {
      ...
      return this.sandbox.on('cancelar-lado-izquierdo-view', this.cancelar);
    },
    cancelar: function() {
      ...
      return this.moldura413.checked = false;
    },
    mostrarLadoIzquierdoOnView: function() {
      var ladoIzquierdo;
      ...
      if (ladoIzquierdo.molduras === 'BIEN') {
        return this.moldura113.checked = true;
      } else if (ladoIzquierdo.molduras === 'REG') {
        return this.moldura213.checked = true;
      } else if (ladoIzquierdo.molduras === 'MAL') {
        return this.moldura313.checked = true;
      } else if (ladoIzquierdo.molduras === 'NO') {
        return this.moldura413.checked = true;
      }
    },
    actualizarladoIzquierdo: function() {
      var ladoIzquierdo;
