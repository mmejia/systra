...
define(['core/sandbox'], function(sandbox) {
  var ManagerParteFrente;
  return ManagerParteFrente = {
    cofre1: null,
    cofre2: null,
    cofre3: null,
    cofre4: null,
    ...
    iniciar: function() {
      ...
      return this.sandbox.on('cancelar-parte-frente-view', this.cancelar);
    },
    cancelar: function() {
      ...
      return this.accesorio4.checked = false;
    },
    mostrarParteFrenteView: function() {
      var parteFrente;
      ...
      if (parteFrente.accesorios === 'BIEN') {
        return this.accesorio1.checked = true;
      } else if (parteFrente.accesorios === 'REG') {
        return this.accesorio2.checked = true;
      } else if (parteFrente.accesorios === 'MAL') {
        return this.accesorio3.checked = true;
      } else if (parteFrente.accesorios === 'NO') {
        return this.accesorio4.checked = true;
      }
    },
    actualizarParteFrente: function() {
      var parteFrente;
      ...
      if (this.acccesorio1.checked === true) {
        return parteFrente.accesorios = 'BIEN';
      } else if (this.acccesorio2.checked === true) {
        return parteFrente.accesorios = "REG";
      } else if (this.acccesorio3.checked === true) {
        return parteFrente.accesorios = 'MAL';
      } else if (this.acccesorio4.checked === true) {
        return parteFrente.accesorios = 'NO';
      }
    }
  };
});
