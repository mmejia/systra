...
define(['core/sandbox'], function(sandbox) {
  var ManagerPartePosterior;
  return ManagerPartePosterior = {
    cajuela1: null,
    cajuela2: null,
    cajuela3: null,
    cajuela4: null,
    ...
    iniciar: function() {
      ...
      return this.sandbox.on('cancelar-parte-posterior-view', this.cancelar);
    },
    cancelar: function() {
      ...
      return this.stopTra4.checked = false;
    },
    mostrarPartePosteriorOnView: function() {
      var partePosterior;
      ...
      if (partePosterior.stop_trasero === 'BIEN') {
        return this.stopTra1.checked = true;
      } else if (partePosterior.stop_trasero === 'REG') {
        return this.stopTra2.checked = true;
      } else if (partePosterior.stop_trasero === 'MAL') {
        return this.stopTra3.checked = true;
      } else if (partePosterior.stop_trasero === 'NO') {
        return this.stopTra4.checked = true;
      }
    },
    actualizarPartePosterior: function() {
      var partePosterior;
      ...
      if (this.stopTra1.checked === true) {
        return partePosterior.stop_trasero = 'BIEN';
      } else if (this.stopTra2.checked === true) {
        return partePosterior.stop_trasero = "REG";
      } else if (this.stopTra3.checked === true) {
        return partePosterior.stop_trasero = 'MAL';
      } else if (this.stopTra4.checked === true) {
        return partePosterior.stop_trasero = 'NO';
      }
    }
  };
});
