...
define(['core/sandbox'], function(sandbox) {
  ...
  return ManagerCajuela = {
    ...
    iniciar: function() {
      ...
      return this.sandbox.on('cancelar-cajuela-view', this.cancelar);
    },
    cancelar: function() {
      ...
      return this.llantasRef4.checked = false;
    },
    mostrarCajuelaOnView: function() {
      var cajuela;
      ...
      if (cajuela.llantas_de_refaccion === 'BIEN') {
        return this.llantasRef1.checked = true;
      } else if (cajuela.llantas_de_refaccion === 'REG') {
        return this.llantasRef2.checked = true;
      } else if (cajuela.llantas_de_refaccion === 'MAL') {
        return this.llantasRef3.checked = true;
      } else if (cajuela.llantas_de_refaccion === 'NO') {
        return this.llantasRef4.checked = true;
      }
    },
    actualizarLadoDerecho: function() {
      ...
      if (this.llantasRef1.checked === true) {
        return cajuela.llantas_de_refaccion = 'BIEN';
      } else if (this.llantasRef2.checked === true) {
        return cajuela.llantas_de_refaccion = "REG";
      } else if (this.llantasRef3.checked === true) {
        return cajuela.llantas_de_refaccion = 'MAL';
      } else if (this.llantasRef4.checked === true) {
        return cajuela.llantas_de_refaccion = 'NO';
      }
    }
  };
});
