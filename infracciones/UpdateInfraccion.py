...
class UpdateInfraccion:
	...
	def do(self):
		infraccion= self.inf
		tbinf= Infraccion.objects.get(id=self.id)
		...
		tbinf.fecha_infrac =infraccion.get('fecha',"")    
